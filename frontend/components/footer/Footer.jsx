...
const Footer = () => {
  return (
    <footer className="py-10 px-5 md:px-20 relative">
      <div className="footerbox md:absolute z-50 -top-20 px-10 py-5 shadow-2xl  border-white  border-dashed border-2 rounded-3xl bg-amber-400 max-w-lg left-0 right-0 mx-auto text-center">
        <h6 className="leading-8">Empowering your online growth with visionary web design and proven strategies – Atechseva is dedicated to elevating your digital presence and exceeding your expectations.</h6>
      </div>
      <div className="text-white pt-24">
        <div className="container mx-auto flex flex-wrap  justify-between">
          <div className="w-full lg:w-1/4 p-2 flex md:block justify-between">
            <h2 className=" text-2xl md:text-4xl font-bold">Let’s start <br /> working together <br /> get in touch!</h2>
            <Link 
              className="flex items-center md:inline-block mt-4 md:mt-10 px-6 py-4 text-secondary-800  bg-amber-500 hover:bg-amber-600 rounded-xl"
              href="https://demo.rstheme.com/wordpress/axios/contact/"
              target="_blank"
          ...
          <div className="w-full lg:w-1/4 p-2">
            <h5 className="text-xl font-semibold">Popular Projects</h5>
            <div className="navigations">
              <ul className="flex flex-col gap-4 mt-5">
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/"> <SlArrowRightCircle />
                  E-Commerce Platform</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/about-us"> <SlArrowRightCircle />
                  Online Food Ordering System</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/contact-us"> <SlArrowRightCircle />
                  Human Resource Management System</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/snippets"> <SlArrowRightCircle />
                  Content Management System</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/blog"> <SlArrowRightCircle />
                  Hotel Reservation System</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/faq"> <SlArrowRightCircle />
                  Pizza Ordering Application</Link></li>
              </ul>
            </div>
          ...
          <div className="w-full lg:w-1/4 p-2">
            ...
            <div className="navigations">
              <ul className="flex flex-col gap-4 mt-5">
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/">
                  <SlArrowRightCircle />
                  Home</Link></li>
                <li> <Link className=" flex gap-3 items-center hover:text-amber-400 text-gray-300" href="/about-us"> <SlArrowRightCircle />
                  About Us</Link></li>
          ...
          <div className="w-full lg:w-1/4 p-2">
            ...
            <div className="mt-4 flex flex-col gap-4 text-gray-300">
              <div className="flex items-center mb-2">
                <Image width={10} height={10}
                  ...
                  alt="Contact Icon"
                />
                <span>183, Main Mawana, Meerut 250001</span>
              </div>
              <div className="flex items-center mb-2">
                <Image width={10} height={10}
                  className="w-6 h-6 mr-2"
                  ...
                  alt="Phone Icon"
                />
                <Link  href="tel:+88015569569">(+91) 7017742830</Link>
              </div>
              <div className="flex items-center mb-2">
                <Image width={10} height={10}
                  className="w-6 h-6 mr-2"
                  ...
                  alt="Email Icon"
                />
                <Link  href="mailto:support@rstheme.com">support@atechseva.com</Link>
              </div>
            </div>

            <ul className="flex justify-center lg:justify-start space-x-4 mt-10 ">
              <button className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                ...
                <div
                  className="absolute top-full left-0 w-full h-full rounded-full bg-blue-500 z-0 transition-all duration-500 group-hover:top-0">
                </div>
              </button>
              ...
              <button className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
                ...
                <div
                  className="absolute top-full left-0 w-full h-full rounded-full bg-[#FF3000] z-0 transition-all duration-500 group-hover:top-0">
                </div>
              </button>
            </ul>
          </div>
        ...
        <div className="container mx-auto mt-8 flex flex-wrap items-center justify-between border-t border-gray-200 pt-4">
          <div className="w-full lg:w-1/3 p-2 text-center lg:text-left">
            <span>
              Copyright © <span id="current-year">2024</span>. Designed by{" "}
              <Link 
          ...
          <div className="w-full lg:w-1/3 p-2 text-center">
            <Link  href="https://demo.rstheme.com/wordpress/axios">
          ...
          <div className="w-full lg:w-1/3 p-2 text-center lg:text-right">
